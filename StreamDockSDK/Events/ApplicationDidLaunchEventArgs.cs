...
/// <summary>
///     Event args for applicationDidLaunch event
///     Received when a monitored application (defined in manifest.json) is launched
/// </summary>
public class ApplicationDidLaunchEventArgs : BaseStreamDockEventArgs
{
    /// <summary>
